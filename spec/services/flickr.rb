...
FakeWeb.register_uri(:get, 'http://api.flickr.com/services/rest?user_id=59532755%40N00&per_page=3&method=flickr.people.getPublicPhotos&api_key=secret', :body => <<-RESPONSE)
<?xml version="1.0" encoding="utf-8" ?>
<rsp stat="ok">
